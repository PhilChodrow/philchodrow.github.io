...
This page collects some frequently asked questions about how to interact with me, the courses I teach, my research (and how students can get involved), and various other things about me. 
...
### Does this course count towards the majors in mathematics or statistics? 
...
I expect to teach this course *roughly* once every two years. 
...
Most of my research these days involves using mathematical and computational techniques to study complex systems. Some of my current interests include gender representation in academic science, mathematical models of social hierarchies, and identity groups in higher-order networks. You can learn more about my research areas and find my publications on my [research page](research.qmd).
...
Usually no. Machine learning is not my research area, and problems of the form "I would like to apply X method to Y data set" usually don't have enough scholarly depth for senior theses. If you have a specific idea related to machine learning that goes over and above "I am going to analyze a data set," then I'm happy to consider your pitch. 
...
The following items are very helpful and significantly increase the likelihood that I will accept you as a research student: 
...
[*The reason I am so picky about independent studies is that they are a lot of extra work which isn't really recognized by the college in any way*.]{.aside}
...
- **Writing**: LaTeX and Markdown. I use LaTeX for most technical writing, including scientific articles, reviews of other's writings, working notes containing proofs and similar things, and any time I want to produce a PDF document. Lots of folks don't like LaTeX, but perhaps through raw familiarity I am a very cheerful LaTeX writer. I use Markdown for most other writing, especially including writing for websites like this one. 
    - I have taken some tentative steps into learning [Typst](https://typst.app/), a competitor to LaTeX. My [CV](https://www.philchodrow.prof/cv/cv.pdf) is constructed in Typst. I haven't decided yet whether I'm going to invest in learning more Typst. 
- **Slides**: [reveal.js](https://revealjs.com/) via [Quarto](https://quarto.org/docs/presentations/revealjs/). I've created a few custom css themes for my slides. I also cheerfully use Google Slides. I previously did a lot of slides in Beamer (LaTeX), but since moved away to HTML slides and haven't looked back. 
- **Slides**: [reveal.js](https://revealjs.com/) via [Quarto](https://quarto.org/docs/presentations/revealjs/). I've created a few custom css themes for my slides. I am also comfortable using 
